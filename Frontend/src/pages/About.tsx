            ...
            <div className="container mx-auto px-6 max-w-5xl relative z-10">
                ...
                <BlurIn className="mb-20">
                    ...
                    <GlassCard className="p-8 md:p-10 mt-6 space-y-4 text-sm text-muted leading-relaxed">
                        <p><span className="text-primary font-semibold">GoalSense</span> is a graduation project developed at our university's Computer Science and Engineering department. The project addresses a real-world problem: making professional-level football analytics accessible to coaches, analysts, and clubs.</p>
